...
ax.plot(t_set[50000:52000], takaishi09_basic_sv_gen_model.gen_y_t_vals(
    TRIAL_VALUES["eta_variance"], TRIAL_VALUES["mu"],
    TRIAL_VALUES["phi"], num_steps_to_gen=len(t_set))[0][50000:52000], linewidth=0.25)
...
ax.plot(t_set[50000:52000], takaishi09_basic_sv_gen_model.gen_h_t_set(
    TRIAL_VALUES["h_1"], TRIAL_VALUES["mu"], TRIAL_VALUES["phi"],
    takaishi09_basic_sv_gen_model.gen_eta_t_values(
        TRIAL_VALUES["eta_variance"], n_to_gen=len(t_set)))[50000:52000], linewidth=0.25)
...
ax.plot(t_set[50000:52000], takaishi09_basic_sv_gen_model.gen_y_t_vals(
    0.3, TRIAL_VALUES["mu"],
    TRIAL_VALUES["phi"], num_steps_to_gen=len(t_set))[0][50000:52000], color="0.3", linewidth=0.25)
ax.set(xlabel=r"Time, $t$", ylabel=r"$y_t$")
